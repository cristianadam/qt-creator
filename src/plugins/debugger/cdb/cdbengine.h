...
private:
    ...
    bool isCdbProcessRunning() const { return m_process.state() != Utils::ProcessState::NotRunning; }
    ...
    int m_pendingInterpreterBreakpointInserts = 0;
    bool m_runEngineOnInterpreterBreakpointsInserted = false;
