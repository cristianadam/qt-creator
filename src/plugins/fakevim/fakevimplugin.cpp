...
void FakeVimExCommandsMappings::initialize()
{
...
class FakeVimExCommandsWidget : public IOptionsPageWidget
{
public:
    FakeVimExCommandsWidget()
    {
        m_widget = new FakeVimExCommandsMappings;
    ...
    FakeVimExCommandsMappings *m_widget;
};
