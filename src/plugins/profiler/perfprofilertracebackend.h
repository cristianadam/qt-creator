...
public:
    ...
    // Actions the tool offers in the Analyze menu and this trace's context menus.
    void setMenuActions(const QList<QAction *> &loadSaveActions, QAction *limitToRange,
                        QAction *showFullRange);
