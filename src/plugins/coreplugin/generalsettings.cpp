    ...
    , m_resetWarningsButton(new QPushButton)
{
    ...
    if (!Utils::HostOsInfo::isMacHost()) {
        ...
        dpiRow = Items{QString(), dpiCheckbox, Break()};
    ...
    Column {
        Group {
            ...
            Form {
                tr("Color:"), m_colorButton, resetColorButton, Stretch(), Break(),
                tr("Theme:"), m_themeChooser, Break(),
                tr("Language:"), m_languageBox, Stretch(), Break(),
                dpiRow,
                QString(), m_showShortcutsInContextMenus, Break(),
                Row { m_resetWarningsButton, Stretch() }, Break(),
                tr("Text codec for tools:"), m_codecBox, Stretch()
            }
        }
    }.attachTo(this);
