...
public:
    ...
    using ExtraToolBarWidgetCreator = std::function<QWidget *()>;
    static void addExtraToolBarWidgetCreator(const ExtraToolBarWidgetCreator &creator);
    ...
    static QAction *createDiffAgainstCurrentEditorAction(
