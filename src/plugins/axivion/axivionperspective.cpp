    ...
    : QScrollArea(parent)
{
    ...
    const Icon build({{":/utils/images/project.png", Theme::PanelTextColorMid},
                      {":/axivion/images/local.png", Theme::PanelTextColorMid}}, Icon::Tint);
    m_localBuild->setIcon(build.icon());
    m_localBuild->setToolTip(Tr::tr("Local Build..."));
    m_localBuild->setEnabled(false);
    m_localDashBoard = new QToolButton(this);
    const Icon dashboard({{":/axivion/images/dashboard.png", Theme::PanelTextColorMid},
                          {":/axivion/images/local.png", Theme::PanelTextColorMid}}, Icon::Tint);
