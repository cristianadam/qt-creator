...
// Where qwebchannel.js was found, which decides whether a webview can talk back
// to its extension at all. Empty when none of the places it can be has it.
Utils::FilePath webChannelScriptPath();
