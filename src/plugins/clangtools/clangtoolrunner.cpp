...
#include <solutions/tasking/concurrentcall.h>
                        ...
                        const AnalyzeOutputHandler &outputHandler)
{
    ...
    const Group group {
        ...
        Group {
            ...
            ConcurrentCallTask<Diagnostics>(onReadSetup, onReadDone, onReadError)
        }
    };
    return group;
}
