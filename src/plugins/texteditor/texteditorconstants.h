...
inline constexpr char GOTO_PREVIOUS_PARAGRAPH[] = "TextEditor.GotoPreviousParagraph";
inline constexpr char GOTO_NEXT_PARAGRAPH[]   = "TextEditor.GotoNextParagraph";
...
inline constexpr char GOTO_PREVIOUS_PARAGRAPH_WITH_SELECTION[] = "TextEditor.GotoPreviousParagraphWithSelection";
inline constexpr char GOTO_NEXT_PARAGRAPH_WITH_SELECTION[] = "TextEditor.GotoNextParagraphWithSelection";
