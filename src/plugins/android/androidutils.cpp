...
{
    QString suffix;
    if (bc->extraData(Android::Constants::AndroidBuildTargetDirSupport).toBool()
        && bc->extraData(Android::Constants::UseAndroidBuildTargetDir).toBool())
...
bool skipInstallationAndPackageSteps(const BuildConfiguration *bc)
{
    ...
    if (p->type() == CMakeProjectManager::Constants::CMAKE_PROJECT_ID)
...
QString androidNameForApiLevel(int x)
{
    ...
    case 37:
        return QLatin1String("Android 17.0 (\"CinnamonBun\")");
    default:
