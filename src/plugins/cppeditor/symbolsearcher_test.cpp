...
public:
                           ...
                           const ResultDataList &expectedResults)
    {
        ...
        QFuture<Utils::SearchResultItem> search
            = Utils::asyncRun(&Internal::search, CppModelManager::snapshot(),
...
void SymbolSearcherTest::test_data()
{
    ...
    searchParameters.flags = {};
    searchParameters.types = Classes;
    searchParameters.scope = SearchGlobal;
    ...
    searchParameters.flags = {};
    searchParameters.types = Functions;
    searchParameters.scope = SearchGlobal;
    ...
    searchParameters.flags = {};
    searchParameters.types = Declarations;
    searchParameters.scope = SearchGlobal;
