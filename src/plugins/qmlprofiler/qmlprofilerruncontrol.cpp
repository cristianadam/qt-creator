...
Group qmlProfilerRecipe(RunControl *runControl)
{
    ...
    const auto onSetup = [runControl](Barrier &barrier) {
        ...
        QObject::connect(clientManager, &QmlProfilerClientManager::connectionOpened,
                         iface, &RunInterface::started);
        ...
        QObject::connect(iface, &RunInterface::canceled, runControl, [iface] {
