    ...
    : QDialog(parent)
{
    ...
    auto sizeLabel = new QLabel(tr("Key &size:"));
    sizeLabel->setBuddy(m_comboBox);
    ...
    Column {
        Group {
            Title(tr("Options")),
            Form {
                tr("Key algorithm:"), Row { m_rsa, m_ecdsa, st }, nl,
                sizeLabel, Row { m_comboBox, st }, nl,
                tr("Private key file:"), Row { m_privateKeyFileValueLabel, privateKeyFileButton, st }, nl,
