    ...
    IDeviceWidget(device)
{
    ...
    Form {
        tr("Machine type:"), m_machineTypeValueLabel, nl,
        tr("Authentication type:"), Row {m_defaultAuthButton, m_keyButton, st }, nl,
        tr("&Host name:"), Row { m_hostLineEdit, sshPortLabel, m_sshPortSpinBox, m_hostKeyCheckBox, st }, nl,
        tr("Free ports:"), Row { m_portsLineEdit, m_portsWarningLabel, tr("Timeout:"), m_timeoutSpinBox, st }, nl,
        tr("&Username:"), m_userLineEdit, nl,
        m_keyLabel, Row { m_keyFileLineEdit, createKeyButton, st }, nl,
        tr("GDB server executable:"), m_gdbServerLineEdit
    }.attachTo(this);
