            ...
            for (const auto &[msg, func] : m_messageCallbacks.asKeyValueRange()) {
                c->registerCustomMethod(msg,
                                        [name = msg, f = func](
                                            ...
                                            auto table = ::Lua::LuaEngine::toTable(o);
...
{
    auto wrapperClass = ::Lua::LuaEngine::instance().lua().new_usertype<LuaClientWrapper>(
        "LuaClientWrapper", sol::constructors<LuaClientWrapper(LuaClientSettings *)>());

    wrapperClass.set("on_instance_start",
                     sol::property(
    ...
    wrapperClass.set("registerMessage",
