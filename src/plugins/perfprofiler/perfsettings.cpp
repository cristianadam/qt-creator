...
{
public:
    PerfConfigWidget(PerfSettings *settings, Target *target, bool tracePointsVisible);
...
PerfConfigWidget::PerfConfigWidget(PerfSettings *settings, Target *target, bool tracePointsVisible)
    : m_settings(settings)
{
    ...
    useTracePointsButton->setVisible(tracePointsVisible);
    ...
    : m_target(target)
{
    ...
    setLayouter([this] {
        using namespace Layouting;
        auto widget = new PerfConfigWidget(this, m_target, m_target != nullptr);
...
QWidget *PerfSettings::createPerfConfigWidget()
{
    return new PerfConfigWidget(this, m_target, true);
}
