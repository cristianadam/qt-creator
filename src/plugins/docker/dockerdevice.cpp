...
{
public:
    ContainerShell(QString containerId)
...
protected:
    CommandLine startCommandLine() override
    {
        return {"docker", {"container" , "start", "-i", "-a", m_containerId}};
    }

    QString threadName() override {
        return QString("Container Shell thread (%1)").arg(m_containerId);
    }
