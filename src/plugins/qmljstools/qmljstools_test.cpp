...
// The following two tests cover the editor-level QML auto-indentation that the
// removed Squish system test suite_QMLS/tst_QMLS08 used to exercise: the "Auto-
// indent Selection" (Ctrl+I) action and auto-indentation while typing. The
// indentation *computation* is covered by tests/auto/qml/qmleditor/
// qmlcodeformatter; here we drive the QML indenter (createQmlJsIndenter) through
// TextDocument::autoReindent()/autoIndent() so the wiring that applies it to the
// document is tested too.
