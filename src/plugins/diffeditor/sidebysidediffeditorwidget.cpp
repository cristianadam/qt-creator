...
SideBySideDiffOutput SideDiffData::diffOutput(QPromise<void> &promise, int progressMin,
...
//        });
        ...
        const SideBySideDiffOutput output = SideDiffData::diffOutput(voidPromise, 0, firstPartMax,
                                                                     input);
        if (promise.isCanceled())
            return;
