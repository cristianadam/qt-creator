...
void PySideBuildStep::checkForPySide(const Utils::FilePath &python)
{
    PySideTools tools;
...
void PySideBuildStep::checkForPySide(const Utils::FilePath &python, const QString &pySidePackageName)
{
...
Utils::Id PySideBuildStep::id()
{
    return Utils::Id("Python.PysideBuildStep");
}
...
public:
        ...
        : NamedWidget(Tr::tr("Python"))
    {
        ...
        if (const std::optional<Utils::FilePath> venv = bc->venv()) {
...
void PythonBuildConfiguration::handlePythonUpdated(const Utils::FilePath &python)
{
...
void PythonBuildConfiguration::fromMap(const Utils::Store &map)
{
...
void PythonBuildConfiguration::toMap(Utils::Store &map) const
{
...
PythonBuildConfigurationFactory::PythonBuildConfigurationFactory()
{
    ...
    setBuildGenerator([](const Kit *k, const FilePath &projectPath, bool forSetup) {
        if (std::optional<Interpreter> python = PythonKitAspect::python(k)) {
            ...
            base.hideBuildDirConfigWidget = true;
            ...
            BuildInfo venv; const FilePath venvBase = projectPath.parentDir() / ".qtcreator"
