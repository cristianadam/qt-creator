...
void BranchModel::checkoutBranch(const QModelIndex &idx, const CommandHandler &handler)
{
    ...
    d->client->checkout(d->workingDirectory, branch, GitClient::StashMode::NoStash, handler);
}
