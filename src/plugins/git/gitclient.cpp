...
void GitBaseDiffEditorController::updateBranchList()
{
    ...
    m_instance->vcsCommand(baseDirectory(), {"branch", noColorOption, "-a", "--contains", revision},
...
void GitClient::status(const FilePath &workingDirectory) const
{
    ...
    vcsCommand(workingDirectory, {"status", "-u"}, this, [](const CommandResult &) {
...
void GitClient::checkout(const FilePath &workingDirectory, const QString &ref,
                         StashMode stashMode, const VcsBase::CommandHandler &handler)
{
    ...
    vcsCommand(workingDirectory, arguments, this, commandHandler,
...
void GitClient::removeStaleRemoteBranches(const FilePath &workingDirectory, const QString &remote)
{
    ...
    vcsCommand(workingDirectory, arguments, this, commandHandler, RunFlags::ShowSuccessMessage);
}
...
void GitClient::updateSubmodulesIfNeeded(const FilePath &workingDirectory, bool prompt)
{
    ...
    vcsCommand(workingDirectory, {"submodule", "update"},
...
void GitClient::push(const FilePath &workingDirectory, const QStringList &pushArgs)
{
    const auto commandHandler = [=](const CommandResult &result) {
        ...
        if (pushFailure == PushFailure::NonFastForward) {
            ...
            vcsCommand(workingDirectory, QStringList{"push", "--force-with-lease"} + pushArgs,
        ...
        vcsCommand(workingDirectory, fallbackCommandParts.mid(1),
                   this, commandHandler, RunFlags::ShowSuccessMessage);
    };
    vcsCommand(workingDirectory, QStringList({"push"}) + pushArgs, this, commandHandler,
               RunFlags::ShowSuccessMessage);
}
...
void GitClient::stashPop(const FilePath &workingDirectory, const QString &stash)
{
    ...
    vcsCommand(workingDirectory, arguments, this, commandHandler, RunFlags::ExpectRepoChanges);
}
