...
Tasking::Group ShowController::reloadRecipe()
{
    ...
    const auto onDescriptionDone = [this, storage, updateDescription](const QtcProcess &process) {
        ...
        const QString busyMessage = Tr::tr("<resolving>");
        data->m_branches = busyMessage;
        data->m_precedes = busyMessage;
        data->m_follows.append(busyMessage);
        updateDescription(*data);
    };

    const auto desciptionDetailSetup = [storage] {
    ...
    const auto setupFollows = [this, storage, updateDescription](TaskTree &taskTree) {
        ...
        const auto onFollowsError = [storage, updateDescription] {
            ReloadStorage *data = storage.activeStorage();
    ...
    const Group root {
        ...
        Group {
            ...
            Group {
                parallel,
                optional,
                DynamicSetup(desciptionDetailSetup),
