...
{
    if (filePath.withNewFileName(".git") != filePath)
        return false;
    if (filePath.isDir())
        return true;
...
void GitTest::testChangesStatusParsing_data()
{
    ...
    QTest::newRow("modified-unstaged")
        ...
        << VcsFileStatusList{{file, FileState::Modified, Section::Changes}};
    ...
    QTest::newRow("modified-both")
        ...
        << VcsFileStatusList{{file, FileState::Modified, Section::Staged},
                             {file, FileState::Modified, Section::Changes}};
    ...
    QTest::newRow("deleted-unstaged")
        ...
        << VcsFileStatusList{{file, FileState::Deleted, Section::Changes}};
    ...
    QTest::newRow("untracked")
        ...
        << VcsFileStatusList{{file, FileState::Untracked, Section::Changes}};
    ...
    QTest::newRow("unmerged-both-modified")
        ...
        << VcsFileStatusList{{file, FileState::Unmerged, Section::Unmerged}};
