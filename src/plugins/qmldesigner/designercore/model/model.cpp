                                             ...
                                             bool isRootNode)
{
    ...
    for (const auto &propertyPair : auxPropertyList)
        newNode->setAuxiliaryData(AuxiliaryDataKeyView(propertyPair.first), propertyPair.second);
