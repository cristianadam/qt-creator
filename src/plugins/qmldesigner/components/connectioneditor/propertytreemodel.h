...
private:
    ...
    void testModel();
    const QList<ModelNode> allIdsSorted() const;
    ...
    const std::vector<PropertyName> sortedDotPropertyNames(const ModelNode &modelNode,
                                                           const PropertyName &propertyName) const;

    const std::vector<PropertyName> sortedDotPropertySignals(const ModelNode &modelNode,
                                                             const PropertyName &propertyName) const;

    const std::vector<PropertyName> sortedDotPropertySlots(const ModelNode &modelNode,
                                                           const PropertyName &propertyName) const;
