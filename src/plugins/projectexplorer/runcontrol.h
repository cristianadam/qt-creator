...
class PROJECTEXPLORER_EXPORT RunStorage : public QObject
{
    Q_OBJECT
...
PROJECTEXPLORER_EXPORT Tasking::Storage<RunStorage> runStorage();
using Canceler = std::function<std::pair<RunStorage *, void (RunStorage::*)()>()>;
