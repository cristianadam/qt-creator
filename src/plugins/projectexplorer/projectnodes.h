...
public:
    ...
    FolderNode *findFolderNode(const std::function<bool (FolderNode *)> &predicate) const; // non-recursive
    FileNode *findFileNode(const std::function<bool (FileNode *)> &predicate) const; // non-recursive
