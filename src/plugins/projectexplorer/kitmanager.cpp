...
static KitAspectFactories &kitAspectFactoriesImpl()
{
...
{
    return kitAspectFactoriesImpl().m_aspectList;
}
...
{
    kitAspectFactoriesImpl().addKitAspect(this);
}

KitAspectFactory::~KitAspectFactory()
{
    kitAspectFactoriesImpl().removeKitAspect(this);
}
