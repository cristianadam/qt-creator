...
const char USE_BUILTIN_FORMATTER[] = "QmlJSEditor.useBuiltInFormatter";
...
QmlJsEditingSettings::QmlJsEditingSettings()
{
    ...
    useBuiltInFormatter.setSettingsKey(group, USE_BUILTIN_FORMATTER);
    useBuiltInFormatter.setDefaultValue(false);
    useBuiltInFormatter.setLabelText(
        Tr::tr("Use built-in formatter [Deprecated]"));
