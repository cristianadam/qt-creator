...
Rectangle {
    ...
    property bool doNotShowAgain: true //Ok button clicked //doNotShowCheckBox.checked
    ...
    RowLayout {
        ...
        CustomButton {
            ...
            onClicked: Qt.openUrlExternally("https://www.qt.io/terms-conditions/legal-notice")
        }
