...
DataModelDownloader::DataModelDownloader(QObject * /* parent */)
{
    ...
    connect(&m_fileDownloader, &QmlDesigner::FileDownloader::finishedChanged, this, [this] {
        ...
        if (m_fileDownloader.finished()) {
            ...
            auto unarchiver = new Async<Result>;
            unarchiver->setConcurrentCallData(unarchive, archiveFile, tempFilePath());
            QObject::connect(unarchiver, &Async<Result>::done, this, [this, unarchiver]() {
