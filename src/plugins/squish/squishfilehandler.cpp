                                               ...
                                               const QStringList &cases)
{
    ...
    item->setFilePath(suiteConf.toString());
...
void SquishFileHandler::openTestSuites()
{
    ...
    for (const QString &suite : chosenSuites) {
        const Utils::FilePath suiteDir = Utils::FilePath::fromString(suite);
...
void SquishFileHandler::runTestSuite(const QString &suiteName)
{
    ...
    QStringList testCases = SquishTestTreeModel::instance()->getSelectedSquishTestCases(suiteConf.toString());
