...
public:
        ...
        , m_role(role)
    {
        ...
        const QString label = role == User ? QStringLiteral("<b>You:</b>")
                                           : QStringLiteral("<b>Agent:</b>");
...
private:
    ...
    {
        return Utils::creatorColor(m_role == User
            ? Utils::Theme::ChatUserMessageBackground
            : Utils::Theme::ChatAgentMessageBackground);
    }
...
public:
        ...
        : CollapsibleFrame(parent)
    {
        ...
        hpal.setColor(QPalette::WindowText,
                      Utils::creatorColor(Utils::Theme::ChatThoughtText));
...
public:
        ...
        : CollapsibleFrame(parent)
    {
        ...
        auto *header = new QLabel(QStringLiteral("<b>Plan:</b>"), this);
        m_headerLayout->addWidget(header, 1);
...
void AcpMessageView::addStatusMessage(const QString &text)
{
    finishAgentMessage();
    finishToolCallGroup();
    ...
    pal.setColor(QPalette::WindowText,
                 Utils::creatorColor(Utils::Theme::ChatStatusText));
...
QWidget *AcpMessageView::wrapWithSpacer(QWidget *widget, Qt::Alignment side)
{
    ...
    if (side == Qt::AlignRight) {
        hbox->addSpacerItem(new QSpacerItem(100, 0, QSizePolicy::MinimumExpanding));
