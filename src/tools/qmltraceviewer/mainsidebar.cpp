...
MainSidebar::MainSidebar(QWidget *parent)
    : QWidget(parent)
{
    auto title = new QLabel(Tr::tr("Traces"));
    title->setContentsMargins(SpacingTokens::PaddingHM, SpacingTokens::PaddingVS,
                              SpacingTokens::PaddingHM, SpacingTokens::PaddingVS);
