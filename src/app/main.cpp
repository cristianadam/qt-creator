...
// The installer can write that to load optional plugins from outside the application bundle
// on macOS, because installing optional plugins into the application bundle would break
// code signing.
