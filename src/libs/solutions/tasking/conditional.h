...
TASKING_EXPORT ThenItem operator>>(const If &ifItem, const Then &thenItem);
TASKING_EXPORT ThenItem operator>>(const ElseIfItem &elseIfItem, const Then &thenItem);
TASKING_EXPORT ElseIfItem operator>>(const ThenItem &thenItem, const ElseIf &elseIfItem);
TASKING_EXPORT ElseItem operator>>(const ThenItem &thenItem, const Else &elseItem);
