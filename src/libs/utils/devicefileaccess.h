...
protected:
    ...
    virtual expected<void, QString> copyFile(const FilePath &filePath, const FilePath &target) const;
    ...
    virtual expected<QByteArray, QString> fileContents(const FilePath &filePath,
                                                       qint64 limit,
                                                       qint64 offset) const;
    virtual expected<qint64, QString> writeFileContents(const FilePath &filePath,
...
protected:
    ...
    expected<void, QString> copyFile(const FilePath &filePath,
                                     const FilePath &target) const override;
    ...
    expected<QByteArray, QString> fileContents(const FilePath &filePath,
                                               qint64 limit,
                                               qint64 offset) const override;
    expected<qint64, QString> writeFileContents(const FilePath &filePath,
                                                const QByteArray &data,
                                                qint64 offset) const override;
};
