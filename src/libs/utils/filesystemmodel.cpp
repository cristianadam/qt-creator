...
static QRegularExpression QRegularExpression_fromWildcard(QStringView pattern, Qt::CaseSensitivity cs)
{
    ...
    //return QRegularExpression(wildcardToRegularExpression(pattern, QRegularExpression::DefaultWildcardConversion), reOptions);
    return QRegularExpression(QRegularExpression::wildcardToRegularExpression(pattern), reOptions);
}
