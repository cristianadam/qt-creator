...
public:
    ...
    Utils::ProcessState state() const;
    ProcessResultData resultData() const;

    int exitCode() const;
    Utils::ProcessExitStatus exitStatus() const;

    Utils::ProcessError error() const;
    ...
    void setProcessChannelMode(Utils::ProcessChannelMode mode);
    Utils::ProcessChannelMode processChannelMode() const;
    ...
    bool isRunning() const; // Short for state() == Utils::Running.
