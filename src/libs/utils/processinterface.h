...
public:
    ...
    Utils::ProcessChannelMode m_processChannelMode = Utils::SeparateChannels;
...
public:
    int m_exitCode = 0;
    Utils::ProcessExitStatus m_exitStatus = Utils::NormalExit;
    Utils::ProcessError m_error = Utils::UnknownError;
