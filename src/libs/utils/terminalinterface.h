...
{
public:
    virtual void startStubProcess(const Utils::CommandLine &cmd, const ProcessSetupData &setup) = 0;
};

class QTCREATOR_UTILS_EXPORT TerminalInterface : public Utils::ProcessInterface
{
