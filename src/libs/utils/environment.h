...
public:
    ...
    void setCombineWithDeviceEnvironment(bool combine);
    bool combineWithDeviceEnvironment() const;
    ...
    static Environment fromDictionary(const NameValueDictionary &dict);
...
private:
    ...
    bool m_combineWithDeviceEnvironment = false;
};
