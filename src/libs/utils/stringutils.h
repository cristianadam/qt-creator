...
using HightlightCallback = std::function<QTextDocument *(const QString &, const QString &)>;
QTCREATOR_UTILS_EXPORT QTextDocument *highlightCode(const QString &code, const QString &mimeType);
QTCREATOR_UTILS_EXPORT void setCodeHighlighter(const HightlightCallback &highlighter);
