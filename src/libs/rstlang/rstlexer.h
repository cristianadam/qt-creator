...
private:
    ...
    // What stands behind the marker of a list item or of a field opens the
    // body of it, indented to the column it is written at.
    void openValue(const Line &line, int markerLength);
