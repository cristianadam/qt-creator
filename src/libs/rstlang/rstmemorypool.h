...
class RSTLANG_EXPORT MemoryPool
{
...
private:
    ...
    // The AST of a typical documentation block fits in here, so parsing it does
    // not reach the upstream allocator at all.
