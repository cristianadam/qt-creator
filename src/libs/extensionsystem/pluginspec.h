...
public:
    ...
    // Advanced: Use at your own risk!!1!
...
protected:
    ...
    virtual void setDependencySpecs(const QHash<PluginDependency, PluginSpec *> &dependencySpecs);
...
class EXTENSIONSYSTEM_EXPORT PluginSpecImpl : public PluginSpec
{
public:
