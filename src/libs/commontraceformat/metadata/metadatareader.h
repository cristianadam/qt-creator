...
private:
    ...
    Utils::Result<FieldClassPtr> parseFieldClass(const QJsonValue &val, const Schema &schema, int idx) const;
    Utils::Result<FieldLocation> parseFieldLocation(const QJsonObject &obj, int idx) const;
    Utils::Result<void> parseRootStructureFieldClass(const QJsonObject &obj, const QString &key,
