...
struct CMNTRCEFMT_EXPORT NullTerminatedStringFC : FieldClass
{
    ...
    explicit NullTerminatedStringFC() : FieldClass(FieldClassKind::NullTerminatedString) {}
};
...
struct CMNTRCEFMT_EXPORT StaticLengthStringFC : FieldClass
{
    ...
    StringEncoding encoding = StringEncoding::Utf8;
    explicit StaticLengthStringFC() : FieldClass(FieldClassKind::StaticLengthString) {}
};
...
struct CMNTRCEFMT_EXPORT DynamicLengthStringFC : FieldClass
{
    ...
    StringEncoding encoding = StringEncoding::Utf8;
    explicit DynamicLengthStringFC() : FieldClass(FieldClassKind::DynamicLengthString) {}
};
