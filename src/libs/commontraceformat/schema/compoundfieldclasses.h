...
struct CMNTRCEFMT_EXPORT StructureFC : FieldClass
{
    ...
    explicit StructureFC() : FieldClass(FieldClassKind::Structure) {}
};
...
struct CMNTRCEFMT_EXPORT StaticLengthArrayFC : FieldClass
{
    ...
    explicit StaticLengthArrayFC() : FieldClass(FieldClassKind::StaticLengthArray) {}
};
...
struct CMNTRCEFMT_EXPORT DynamicLengthArrayFC : FieldClass
{
    ...
    explicit DynamicLengthArrayFC() : FieldClass(FieldClassKind::DynamicLengthArray) {}
};

// ── Variant ───────────────────────────────────────────────────────────────
// Each option covers a set of integer selector values or ranges.
struct VariantSelectorRange { qint64 lo; qint64 hi; };
...
struct CMNTRCEFMT_EXPORT VariantFC : FieldClass
{
    ...
    explicit VariantFC() : FieldClass(FieldClassKind::Variant) {}
};
...
struct CMNTRCEFMT_EXPORT OptionalFC : FieldClass
{
    ...
    explicit OptionalFC() : FieldClass(FieldClassKind::Optional) {}
};
