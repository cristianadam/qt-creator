...
struct CMNTRCEFMT_EXPORT FixedLengthBitArrayFC : FieldClass
{
    ...
    explicit FixedLengthBitArrayFC() : FieldClass(FieldClassKind::FixedLengthBitArray) {}
};

// ── Fixed-length bitmap (bit flags with named ranges) ────────────────────
struct BitFlagRange { int start; int end; }; // inclusive bit positions within the field
...
struct CMNTRCEFMT_EXPORT FixedLengthBitMapFC : FieldClass
{
    ...
    explicit FixedLengthBitMapFC() : FieldClass(FieldClassKind::FixedLengthBitMap) {}
};
...
struct CMNTRCEFMT_EXPORT FixedLengthBoolFC : FieldClass
{
    ...
    explicit FixedLengthBoolFC() : FieldClass(FieldClassKind::FixedLengthBool) {}
};

// ── Integer mappings: map value ranges to labels ─────────────────────────
struct IntMappingRange { qint64 lower; qint64 upper; }; // signed: bounds may be negative
...
struct CMNTRCEFMT_EXPORT FixedLengthUIntFC : FieldClass
{
    ...
    explicit FixedLengthUIntFC() : FieldClass(FieldClassKind::FixedLengthUInt) {}
};
...
struct CMNTRCEFMT_EXPORT FixedLengthSIntFC : FieldClass
{
    ...
    explicit FixedLengthSIntFC() : FieldClass(FieldClassKind::FixedLengthSInt) {}
};
...
struct CMNTRCEFMT_EXPORT FixedLengthFloatFC : FieldClass
{
    ...
    explicit FixedLengthFloatFC() : FieldClass(FieldClassKind::FixedLengthFloat) {}
};
...
struct CMNTRCEFMT_EXPORT VariableLengthUIntFC : FieldClass
{
    ...
    explicit VariableLengthUIntFC() : FieldClass(FieldClassKind::VariableLengthUInt) {}
};
...
struct CMNTRCEFMT_EXPORT VariableLengthSIntFC : FieldClass
{
    ...
    explicit VariableLengthSIntFC() : FieldClass(FieldClassKind::VariableLengthSInt) {}
};
