...
Item {
    ...
    property bool isSmall: root.width <= Constants.thumbnailBreak ? true : false
    ...
    Drag.source: root
    Drag.hotSpot.x: Constants.thumbnailWH * 0.5
    Drag.hotSpot.y: Constants.thumbnailWH * 0.5
    ...
    Rectangle {
        ...
        property int innerWidth: Constants.thumbnailWH - 2 * stateBackground.thumbPadding
        property int innerHeight: Constants.thumbnailWH - 2 * stateBackground.thumbPadding
        ...
        Column {
            ...
            Grid {
                ...
                StudioControls.AbstractButton {
                    ...
                    onCheckedChanged: console.log("checked changed", defaultButton.checked)
                }
