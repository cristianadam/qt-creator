...
Rectangle {
    ...
    property bool tinyMode: Constants.thumbnailWH <= Constants.thumbnailBreak
    ...
    StudioControls.Dialog {
        ...
        StudioControls.TextField {
            ...
            implicitWidth: editTextField.width
    ...
    Rectangle {
        ...
        Row {
            ...
            Item {
                width: toolBar.width - leftRow.width - rightRow.width
                height: 1
            }
    ...
    Grid {
        ...
        Item {
            ...
            height: root.isLandscape() ? root.height - toolBar.height - (2 * root.padding)
                                       : root.scrollViewHeight
            clip: true
                        ...
                        Repeater {
                            ...
                            delegate: DropArea {
                                ...
                                Rectangle {
                                    ...
                                    visible: {
                                        if (delegateRoot.hasExtend || stateThumbnail.extendedState)
                                            return true
