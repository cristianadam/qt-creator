    ...
    contentItem: Column {
        ...
        Row {
            ...
            HelperWidgets.Button {
                ...
                text: qsTr("Delete")
                onClicked: {
                    AssetLibraryBackend.assetsModel.deleteFiles(root.files, dontAskAgain.checked)
                    root.accept()
                }
            }
    ...
    Component {
        ...
        ListView {
            ...
            delegate: Text {
                ...
                text: model.modelData.replace(AssetLibraryBackend.assetsModel.currentProjectDirPath(), "")
                color: StudioTheme.Values.themeTextColor
