...
void tst_Tasking::validConstructs()
{
    ...
    // Group done handler needs to take (DoneResult) or (void) as an argument and has to
    // return void or bool.
#if 0
    onGroupDone([] { return 7; });
#endif
#if 0
    onGroupDone([](DoneResult) { return 7; });
#endif
#if 0
    onGroupDone([](int) { });
#endif
#if 0
    onGroupDone([](DoneResult, int) { });
#endif
    ...
    // Task done handler needs to take (const Task &, DoneResult), (const Task &),
    // (DoneResult) or (void) as arguments and has to return void or bool.
#if 0
    TestTask({}, [](const TaskObject &, DoneResult) { return 7; });
#endif
#if 0
...
#endif
#if 0
    TestTask({}, [](const TaskObject &, DoneResult, int) {});
#endif
#if 0
    TestTask({}, [](const TaskObject &, int) {});
#endif
#if 0
    TestTask({}, [](DoneResult, int) {});
#endif
#if 0
    TestTask({}, [](int) {});
#endif
#if 0
    TestTask({}, [](const TaskObject &, DoneResult, int) { return true; });
#endif
#if 0
    TestTask({}, [](const TaskObject &, int) { return true; });
#endif
#if 0
    TestTask({}, [](DoneResult, int) { return true; });
#endif
#if 0
