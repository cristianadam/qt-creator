...
private slots:
    void writeRead_8bit_lsb()
    {
        ...
        BitBuffer rb(raw);
        quint64 v = rb.readBits(8, ByteOrder::LittleEndian, BitOrder::LeastSignificantFirst);
        QCOMPARE(v, 0xABu);
    }
    ...
    void writeRead_partial_bits()
    {
        ...
        BitBuffer rb(raw);
        quint64 a = rb.readBits(3, ByteOrder::LittleEndian, BitOrder::LeastSignificantFirst);
        quint64 b = rb.readBits(5, ByteOrder::LittleEndian, BitOrder::LeastSignificantFirst);
        QCOMPARE(a, 0x5u);
        QCOMPARE(b, 0x1Au);
    }
    ...
    void writeRead_32bit_le()
    {
        ...
        BitBuffer rb(raw);
        quint64 got = rb.readBits(32, ByteOrder::LittleEndian, BitOrder::LeastSignificantFirst);
        QCOMPARE(got, val);
    }
    ...
    void writeRead_32bit_be()
    {
        ...
        BitBuffer rb(raw);
        quint64 got = rb.readBits(32, ByteOrder::BigEndian, BitOrder::MostSignificantFirst);
        QCOMPARE(got, val);
    }
    ...
    void patchBits()
    {
        ...
        QByteArray raw = dev.data();
        BitBuffer rb(raw);
        quint64 patched  = rb.readBits(32, ByteOrder::LittleEndian, BitOrder::LeastSignificantFirst);
        quint64 trailing = rb.readBits(16, ByteOrder::LittleEndian, BitOrder::LeastSignificantFirst);
    ...
    void roundtrip_64bit()
    {
        ...
        quint64 got = rb.readBits(64, ByteOrder::LittleEndian, BitOrder::LeastSignificantFirst);
        QCOMPARE(got, val);
    }
};

QTEST_MAIN(tst_BitBuffer)
