...
private slots:
    void uleb128_data()
    {
        ...
        QTest::newRow("max64")   << quint64(UINT64_MAX)  << QByteArray("\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01", 10);
    }
    ...
    void sleb128_data()
    {
        ...
        QTest::newRow("min64")<< INT64_MIN    << QByteArray("\x80\x80\x80\x80\x80\x80\x80\x80\x80\x7f", 10);
        QTest::newRow("max64")<< INT64_MAX    << QByteArray("\xff\xff\xff\xff\xff\xff\xff\xff\xff\x00", 10);
    }
