...
void tst_protocol::reformatUnsignedIntegerTest_data()
{
    ...
    QTest::newRow("fourchar-appl")
        << quint64(0x6170706c) << int(FourCharIntegerFormat) << QString("'appl'");
    QTest::newRow("fourchar-Qt  ")
        << quint64(0x51742020) << int(FourCharIntegerFormat) << QString("'Qt  '");
}
...
void tst_protocol::reformatIntegerOverload_data()
{
    ...
    QTest::newRow("fourchar-appl")
        << quint64(0x6170706c) << int(FourCharIntegerFormat) << 4 << false << QString("'appl'");
