...
TEST_F(McuModuleProjectItem, get_qmlproject_path_existing_qmlproject)
{
    ...
    ASSERT_THAT(path,
                Eq(Utils::FilePath::fromString(
                    localTestDataDir
                    + "/qmldirtoqmlproject/existing_qmlproject/test_module.qmlproject")));
}
...
TEST_F(McuModuleProjectItem, get_qmlproject_path_missing_qmlproject)
{
    ...
    ASSERT_THAT(path,
                Eq(Utils::FilePath::fromString(
                    localTestDataDir
                    + "/qmldirtoqmlproject/missing_qmlproject/test_module.qmlproject")));
}
...
TEST_F(McuModuleProjectItem, check_saved_qmlproject_file_missing_qmlproject)
{
    ...
    QmlProjectManager::McuModuleProjectItem savedQmlProject(Utils::FilePath::fromString(
...
TEST_F(McuModuleProjectItem, get_qmlproject_path_invalid_qmlproject)
{
    ...
    ASSERT_THAT(path,
                Eq(Utils::FilePath::fromString(
                    localTestDataDir
                    + "/qmldirtoqmlproject/invalid_qmlproject/test_module.qmlproject")));
}
...
TEST_F(McuModuleProjectItem, get_qmlproject_path_from_json_object)
{
    ...
    ASSERT_THAT(path,
                Eq(Utils::FilePath::fromString(localTestDataDir
...
{
    createFromEmpty->setQmlProjectPath(Utils::FilePath::fromString(
        localTestDataDir + "/qmldirtoqmlproject/test_module.qmlproject"));

    ASSERT_THAT(createFromEmpty->qmlProjectPath(),
                Eq(Utils::FilePath::fromString(localTestDataDir
                                               + "/qmldirtoqmlproject/test_module.qmlproject")));
}
...
{
    auto projectItem = QmlProjectManager::McuModuleProjectItem::fromQmldirModule(
        Utils::FilePath::fromString(localTestDataDir + "/qmldirtoqmlproject/nonexisting"));
...
TEST_F(McuModuleProjectItem, create_from_missing_module_name_qmldir)
{
    auto projectItem = QmlProjectManager::McuModuleProjectItem::fromQmldirModule(
        Utils::FilePath::fromString(localTestDataDir
                                    + "/qmldirtoqmlproject/missing_module_name_qmldir/qmldir"));
...
TEST_F(McuModuleProjectItem, create_from_incorrect_module_name_qmldir)
{
    auto projectItem = QmlProjectManager::McuModuleProjectItem::fromQmldirModule(
        Utils::FilePath::fromString(localTestDataDir
                                    + "/qmldirtoqmlproject/incorrect_module_name_qmldir/qmldir"));
...
TEST_F(McuModuleProjectItem, create_from_missing_qml_files_qmldir)
{
    auto projectItem = QmlProjectManager::McuModuleProjectItem::fromQmldirModule(
        Utils::FilePath::fromString(localTestDataDir
                                    + "/qmldirtoqmlproject/missing_qml_files_qmldir/qmldir"));
