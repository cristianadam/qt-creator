...
* Qt Creator variable `HostOs:BatchFileSuffix`
...
* Tabbed editors:
  ([Documentation](https://doc-snapshots.qt.io/qtcreator/creator-coding-navigating.html#using-tabbed-editors))
...
* A quick fix for adding a class or struct definition from a forward
  ...
  ([Documentation](https://doc-snapshots.qt.io/qtcreator/creator-reference-cpp-quick-fixes.html))
...
* `Copy Cleaned Text` that removes leading dashes and plus signs
...
* The option to resize the category column in the timeline view
