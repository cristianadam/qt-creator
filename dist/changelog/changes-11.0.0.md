...
* Fixed a crash with many results from Silver Searcher
...
* Fixed that `qmllint` issues were not shown in `Issues` view
...
* Fixed that many progress indicators could be created
