...
function(create_standalone_install_component component_name)
  ...
  if (APPLE)
    if (create_appbundle)
      # The bundle directory is named after the target's OUTPUT_NAME (its display
      # name, e.g. "Qt Profiler.app"), falling back to the target name.
      get_target_property(_bundle_output_name ${_arg_TARGET} OUTPUT_NAME)
      if (NOT _bundle_output_name)
        set(_bundle_output_name "${_arg_TARGET}")
      endif()
      set(base_dir "${_bundle_output_name}.app/Contents")
    else()
      set(base_dir ".")
    endif()
    ...
    set(libexec_dest "${base_dir}/MacOS")
...
Qml2Imports=qml
  ...
  install(CODE "file(WRITE \"\${CMAKE_INSTALL_PREFIX}/${resource_dest}/qt.conf\"
               \"${qt_conf}\")"
    COMPONENT ${component_name}
    EXCLUDE_FROM_ALL
  )
