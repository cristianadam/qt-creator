...
list(APPEND DEFAULT_DEFINES
  ...
  QT_NO_SINGLE_ARGUMENT_QHASH_OVERLOAD
)
...
if (APPLE)
  ...
  set(_IDE_DEVEL_LIBRARY_ARCHIVE_INSTALL_PATH "${_IDE_APP_TARGET}.sdk/lib/")
  set(_IDE_DEVEL_LIBRARY_INSTALL_PATH "${_IDE_APP_TARGET}.sdk/lib/")
  set(_IDE_DEVEL_DATA_INSTALL_PATH "${_IDE_APP_TARGET}.sdk/share/qtcreator")
  set(_IDE_DEVEL_HEADER_INSTALL_PATH "${_IDE_APP_TARGET}.sdk/include/qtcreator")
  set(_IDE_DEVEL_CMAKE_INSTALL_PATH "${_IDE_APP_TARGET}.sdk/lib/cmake")
elseif(WIN32)
  ...
  set(_IDE_DEVEL_LIBRARY_ARCHIVE_INSTALL_PATH "${_IDE_BIN_PATH}")
  set(_IDE_DEVEL_LIBRARY_INSTALL_PATH "${_IDE_LIBRARY_PATH}")
  set(_IDE_DEVEL_DATA_INSTALL_PATH "share/qtcreator")
  set(_IDE_DEVEL_HEADER_INSTALL_PATH "include/qtcreator")
  set(_IDE_DEVEL_CMAKE_INSTALL_PATH "lib/cmake")
else ()
  ...
  set(_IDE_DEVEL_LIBRARY_ARCHIVE_INSTALL_PATH "${_IDE_LIBRARY_PATH}")
  set(_IDE_DEVEL_LIBRARY_INSTALL_PATH "${_IDE_LIBRARY_PATH}")
  set(_IDE_DEVEL_DATA_INSTALL_PATH "share/qtcreator")
  set(_IDE_DEVEL_HEADER_INSTALL_PATH "include/qtcreator")
  set(_IDE_DEVEL_CMAKE_INSTALL_PATH "${_IDE_LIBRARY_BASE_PATH}/cmake")
endif ()
...
function(set_public_includes target includes system)
  foreach(inc_dir IN LISTS includes)
    ...
    target_include_directories(${target} ${system} PUBLIC
      ...
      $<INSTALL_INTERFACE:${_IDE_DEVEL_HEADER_INSTALL_PATH}/${include_dir_relative_path}>
    )
  endforeach()
endfunction()
